 ...
 */
@Data
@TableName("recharge_reconcile_log")
@Schema(name = "RechargeReconcileLog对象", description = "支付订单对账中心表")
@Accessors(chain = true)
public class RechargeReconcileLog implements Serializable {
    ...
    @Schema(description ="来源：1-新系统，2-美区（由前端传入)")
    ...
    @Schema(description ="充值【业务】2 已完成 3失败 ")
    ...
    private String bizTokenAddress;
    ...
    @Schema(description ="【对账】结果类型：1完全一致 2业务有链上无 3链上有业务无 4金额不一致 5Hash不一致 6 状态不一致")
